...
- Thin evidence inspector: show the chain from input to output to judgment to next instruction, with enough rows or folded sections to prove scroll behavior.
